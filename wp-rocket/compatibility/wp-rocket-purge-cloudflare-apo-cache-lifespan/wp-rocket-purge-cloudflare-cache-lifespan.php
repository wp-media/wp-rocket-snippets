<?php
/**
 * Plugin Name: WP Rocket | Purge Cloudflare via Cache Lifespan
 * Description: Syncs WP Rocket cache-clearing via Cache Lifespan with CLoudflare APO and Cache Everything.
...
namespace WP_Rocket\Helpers\compatibility\purge_cloudflare_cache_lifespan;

// Standard plugin security, keep this line in place.
defined( 'ABSPATH' ) or die();

function purge_cloudflare_via_cache_lifespan( $deleted ) {
  ...
  if ( defined( 'WP_ROCKET_VERSION' ) ) {
    ...
    // Get the Cloudflare plugin compatibility subscriber from the container
...
add_action( 'rocket_after_automatic_cache_purge', __NAMESPACE__ . '\purge_cloudflare_via_cache_lifespan' );