<?php
/**
 * Plugin Name: WP Rocket | Performance Tweaks (Preload & RUCSS)
 * Description: Optimize CPU usage by tuning Preload, RUCSS parameters and setting a minimum acceptable RUCSS CSS size.
...
namespace WP_Rocket\Helpers\static_files\various\performance_tweaks;
